...
//   //  apply filter for fetched resturant

//   useEffect(() => {
//   const fetch = async () => {
//     try {
//       const response = await getResturantFood(
//         foodType === "Veg",       // vegeterian
//         foodType === "Seasonally",// seasonal
//         foodType === "Non Veg",   // nonVeg
...
//         <div>
//           <section>
//             <h3 className="text-gray-500 py-5">
...
//               <h1 className="text-3xl">{resturantData.name}</h1>
...
//                   {" "}
//                   <FmdGoodOutlinedIcon /> <span> 1.2km from your location</span>
//                 </span>
//                 <span className="text-gray-500">
//                   {" "}
//                   <DateRangeOutlinedIcon /> <span>Opens at 10:00 am</span>{" "}
//                 </span>
//               </span>
//             </div>
//           </section>
...
//           <section className="py-5 w-full flex gap-5 min-h-screen">
//             {/* Left Sidebar */}
//             <div className="w-1/5 sticky top-20 self-start space-y-5 bs-mx:hidden">
//               <div className=" p-3 box space-y-5">
//                 {/* Food Types */}
...
//                         handleFoodcategory(e); // pass event here
//                       }}
//                     >
...
//             {/* Right Content */}
//             <div className="w-5/6 bs-mx:w-full">
//               {menu.map((item, index) => (
